...
builder.Services
    .AddAuthentication(options =>
    {
      ...
      .AddCookie(options =>
      {
          ...
          options.AccessDeniedPath = "/" + section.GetValue<string>("ProjectName") + "/Auth/AccessDenied";      //preprod 
          //options.AccessDeniedPath = "/Auth/AccessDenied";                                                    //for ocal test 
...
using (var scope = app.Services.CreateScope())
{
    ...
    var user = new User
    { UserName = "mgahmed", Role = (Core.Enums.Roles)1, Create_At = DateTime.Now, Created_by = new Guid() };
